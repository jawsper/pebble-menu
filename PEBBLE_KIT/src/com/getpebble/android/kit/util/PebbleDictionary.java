...
/**
 * A collection of key-value pairs of heterogeneous types. PebbleDictionaries are the primary structure used to exchange data between the phone and watch.
 * <p/>
 * To accommodate the mixed-types contained within a PebbleDictionary, an internal JSON representation is used when exchanging the dictionary between Android processes.
 * 
...
public class PebbleDictionary implements Iterable<PebbleTuple>
{
	 ...
	 * {@inheritDoc}
	 */
	@Override public Iterator<PebbleTuple> iterator()
	{
	...
	/**
	 * Returns the unsigned integer to which the specified key is mapped, or null if the key does not exist in this dictionary.
	 * 
	 * @param key
	 *            key whose associated value is to be returned
	 * 
	...
	@SuppressWarnings( "serial" ) public static class PebbleDictTypeException extends RuntimeException
	{
	...
	@SuppressWarnings( "serial" ) public static class TupleOverflowException extends RuntimeException
	{
